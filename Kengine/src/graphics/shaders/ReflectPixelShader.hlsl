...
float4 main(PIn input) : SV_TARGET
{
    ...
    float4 combined = ((input.colour * sampled) * (1.5 - reflectiveness)) + (reflectedSampled * reflectiveness); // hard coded mixes -> use constant buffers to be able to control this
